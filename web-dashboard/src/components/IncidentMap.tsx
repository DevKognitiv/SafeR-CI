    ...
    incidents.forEach((incident) => {
      ...
      const marker = L.marker([incident.location_lat, incident.location_lon], { icon })
        .bindPopup(`<div style="font-family:sans-serif;min-width:180px;color:#1e293b">
          ...
          <span style="padding:2px 8px;border-radius:9999px;font-size:11px;font-weight:600;background:${incident.status === 'open' ? '#FEE2E2' : '#D1FAE5'};color:${incident.status === 'open' ? '#DC2626' : '#059669'}">${incident.status === 'open' ? 'Ouvert' : 'R\u00e9solu'}</span>
